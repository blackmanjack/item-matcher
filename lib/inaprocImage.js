...
// katalog.inaproc.id balas 403 untuk request tanpa header seperti browser normal
// (mis. request polos dari server tanpa User-Agent/Accept) - kirim header ini
// supaya diperlakukan seperti kunjungan browser biasa.
